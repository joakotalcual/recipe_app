...
import 'package:recipe_app/components/my_bottom_nav_bar.dart'; // Importación del componente de barra de navegación inferior personalizada
import 'package:recipe_app/screens/home/components/body.dart'; // Importación del componente del cuerpo de la pantalla de inicio
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: MyBottomNavBar(), // Barra de navegación inferior personalizada
